...
\subsection{Python Application}
\paragraph{Login}
When you first open you will need to sign in with google, by clicking the "Sign in with Google" button. This will take you to your web browser for you to log in, and once authenticated you can close the tab. You will then be in the home page of the application.
\paragraph{Home}
Here you can 
\end{document}

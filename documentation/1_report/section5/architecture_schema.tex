...
\subsubsection{core}
\paragraph{Overview}
Core holds the main logic for parsing and generating the data used for views in the frontend. Core also holds python object representations of all telemetry events, which are used for creating views.
\paragraph{events}
\paragraph{export}
\paragraph{logic}
\paragraph{parsing}

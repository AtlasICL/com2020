...
Several components were developed independently and integrated close to the deadline, which compressed the time available for end-to-end testing. To address this, the team introduced more frequent integration points in Sprint 2 and began cross-application testing earlier.

...
\textbf{Acceptance Criteria}
\begin{itemize}
  \item Each component that accesses data be explained, describing what data it accesses, what it does with it, and why it needs to access this data.
...
\textbf{Acceptance Criteria}
\begin{itemize}
  \item An inventory of all software and data components the system directly depends on must be produced.
...
\begin{itemize}
  ...
  \item Evidence that the test is successful must be given.
  \item The happy path and failure cases for the test must be described.
  \item The expected results of the test must be described.
\end{itemize}

\paragraph{Stakeholders Can View Security Checklist}
\textbf{Value:} 0\quad \textbf{Priority:} Wont\\
\textbf{Acceptance Criteria} NA
...
\textbf{Acceptance Criteria}
\begin{itemize}
  \item The system must read the telemetry data and evaluate it against a suggestion criteria.
  \item If this criteria is met, the system must suggest a concrete change to the design parameter to improve the balance of the game.

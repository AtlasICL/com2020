...
\textbf{Acceptance Criteria}
\begin{itemize}
  \item The guide must contain clear instructions for how to set up and operate both applications.
...
\textbf{Acceptance Criteria}
\begin{itemize}
  \item There must be clear instructions on how to operate the test suite on the source code.
...
\begin{itemize}
  ...
  \item Must provide a schema of the format each data store uses to store data.
...
\subsubsection{Tecnical information}

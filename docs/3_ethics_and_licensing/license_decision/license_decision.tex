...
For this project, we have chosen to use the MIT license,, as it allows our code to be freely used with very few drawbacks, meaning that our code can provide the most widespread usefulness possible. 

...
This represents all the pre-made encounters in the game, holding a list of all enemy enums in the encounter and the name of the encounter for telemetry purposes as well as a display name. It is used when referring to the type of encounter rather than a specific concrete encounter, and thus mostly appears within telemetry. 

...
\begin{itemize}
    ...
    \item \textbf{Emre Acarsoy:} Owns the Telemetry App. Lead developer for Python side, oversaw design and implementation of telemetry. Additionally, implemented settings persistence, Google SSO authentication, and wrote the Software Bill of Materials. Bug fixes across both applications. 
    ...
    \item \textbf{Harry Taylor:} Implemented the TelemetryListener, JSON event writing, and event validation. Implemented the Python suggestion system, and various other parts of the Telemetry app. Contributed to the presentation.

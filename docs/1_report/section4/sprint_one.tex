...
Each subsection is an aspect of the project (either the documentation, python or java application). Each subsubsection is then an epic within that area. Each paragraph represents one story for that epic, referencing a story in the project backlog. Each story is assigned a value associated with how much work is required to complete the story, the risks associated with the story, the technical changes required to complete it, what it depends on, how complex it is to achieve, and what value it adds to the project, assuming all work to be done in the last sprint was done. Each story is also assigned a priority of either Must, Should (which are expected to be completed by the end of the sprint), could and wont. Lastly an acceptance criteria is provided for each story, stating what tasks must be completed to achieve the story. 
...
\textbf{Acceptance Criteria}
\begin{itemize}
  \item Must outline the ethical considerations of the prototype.
...
\textbf{Value:} 1 \quad \textbf{Priority:} Wont\\
\textbf{Acceptance Criteria} N/A

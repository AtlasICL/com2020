...
\paragraph{Authenticaed Users are Assigned a Role}
As a general user I need to be assigned the role of player, designer, or developer dependant on my level of privilege within the game so that I can perform actions related to my role. 

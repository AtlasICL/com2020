...
\paragraph{Suggestions Window}
As a designer I need a suggestions window so that I can view the various design suggestions produced by the application. 
...
As a general user I need to be able to progress from stage to stage so that the threat of each stage increases with the power level of my character. 
...
\paragraph{Use Physical Attack Abilities}

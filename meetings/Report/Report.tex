...
As a developer I need to view information relating to the start of a session so that the system can validate other telemetry events for that session and see what difficulty was chosen for the session. 
TODO
\paragraph{Normal Encounter Start}
As a designer I need to view information relating to the start of a normal encounter so I can know what encounter is taking place, on which stage and on what difficulty.

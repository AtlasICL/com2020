...
**Value:** 1
### Upgrades are purchasable in the shop
The shop should provide a random assortment of available upgrades, with varying power levels and prices. They can be bought with coins and increase the power of the player's character.  
...
Encounter 1. Die and out of lives -> Run Over Screen, Die with lives -> Encounter 1, Kill all enemies -> Shop 1.

Shop 1. Leave shop -> Encounter 2. 

Encounter 2. Die and out of lives -> Run Over Screen, Die with lives -> Encounter 2, Kill all enemies -> Shop 2.

Shop 2. Leave shop -> Encounter 3.

Repeat above to Encounter/shop 9.

Encounter 10. Die and out of lives -> Run Over Screen, Die with lives -> Encounter 10, Kill all enemies -> Win Screen.

Win Screen. Restart -> Title Screen. 

Run Over Screen. Restart -> Title Screen.
...
- If they're a developer they can change design parameters
- If they're a developer they can view a simulated run's results 
...
*As a user, I would like to see an end screen summary of my run so I can compare with friends and see how I have improved.*
...
Each user entry should contain the following information:
- Username
- Hashed and salted password
- Salt
- Whether they have telemetry enabled or not
- Their role
...
The system should detect deal with malformed telemetry. This should include telemetry thats in an impossible order, has missing fields or out-of-range values.  
...
#### Java application must implements coins which can be used to buy upgrades
[Coins](#implements-coins-as-a-resource-for-buying-upgrades)

#### Java application must contain 4 purchasable upgrades. 
They need not be sellable. 

...
public class RandomEntityAIUnitTests {
    ...
    /**
     * The entity AI is tasked with randomly selecting targets to attack, abilities to use
     * and upgrades to purchase. Each of the methods that implement these use the private
     * method shuffleArray(), which uses generics to deal with arrays of any type.
     * This test runs this method on an Integer array of all ordered values 1-10 twice,
     * ensuring that the original differs from both shuffled arrays, and that the shuffled
     * arrays are different from one another.
     *
     * @throws ClassNotFoundException if the private class specified for reflection cannot
     * be found.
     * @throws NoSuchMethodException if the private method specified for reflection cannot
     * be found.
    ...
    void shuffleArray_works() throws ClassNotFoundException, NoSuchMethodException,
        ...
        // Probability of a pair of arrays below having the same order = 1/(10!) = 1 in ~3.26 million

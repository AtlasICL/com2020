...
public interface SettingsInterface {
     ...
     * @throws AuthenticationException if no user is authenticated,
     *                                 or the authenticated user calling the method
     *                                 is not of the Developer role.
     */
    ...
    /**
     * Resets the filepath to the real JSON file, logins_file.json, after running a
     * JUnit test.
     */
    ...
    /**
     * Resets the filepath to the real JSON file, settings_file.json, after running
     * a JUnit test.
     */

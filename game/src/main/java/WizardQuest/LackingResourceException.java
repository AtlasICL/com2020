...
/**
 * Exception representing an issue relating to a lack of entity resources. Either a player is
 * attempting to purchase an upgrade which they have an insufficient coin total for, or they
 * are attempting to use an ability which they have an insufficient magic total for.
 */
